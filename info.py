...
# PyroClient Setup 
API_ID = int(environ['26058820'])
API_HASH = environ['cf34db4ed69493d377a2516056711cb6']
BOT_TOKEN = environ['6490836786:AAEN4m2OyTEVciYGc8KPM2RZBY-udl3QV9o']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5683891175 5000299975').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1001007286792')
auth_grp = environ.get('-1001841131028')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://jk4:jk4@cluster0.smypden.mongodb.net/?retryWrites=true&w=majority")
...
PMFILTER = is_enabled(environ.get('PMFILTER', "flase"), True)
G_FILTER = is_enabled(environ.get("G_FILTER", "True"), True)
BUTTON_LOCK = is_enabled(environ.get("BUTTON_LOCK", "True"), True)
RemoveBG_API = environ.get("RemoveBG_API", "")

# url shortner
SHORT_URL = environ.get("https://flashlinks.in/")
SHORT_API = environ.get("ea6ce368202d9fa31e066b60ebba050692e8923a")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "900"))
LOG_CHANNEL = int(environ.get('-1001827702655', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Movies_Editor_Family_1')
